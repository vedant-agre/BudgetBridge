...
import { Star, Bed, MapPin, ExternalLink } from "lucide-react";
...
export function HotelCard({ hotel }: { hotel: Hotel }) {
  ...
  return (
    ...
    >
      <div className="flex justify-between items-start mb-2">
        <h3 className="font-semibold text-lg flex items-start gap-2">
          ...
          <a 
            ...
            className="line-clamp-2 hover:text-blue-600 dark:hover:text-blue-400 transition-colors flex items-center gap-1.5"
        ...
        <div className="flex items-center gap-1 bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-500 px-2 py-1 rounded-full text-xs font-bold shrink-0 ml-2">
      ...
      {hotel.shortAddress && (
        <div className="flex items-center gap-1.5 text-xs font-medium text-zinc-500 dark:text-zinc-400 mb-3 ml-7">
